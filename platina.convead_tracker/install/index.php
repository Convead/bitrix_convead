...
if (class_exists('platina_convead_tracker')) {
    return;
}



class platina_convead_tracker extends CModule {

    var $MODULE_ID = 'platina.convead_tracker';
    ...
    function platina_convead_tracker() {
        ...
        $this->MODULE_ID = 'platina.convead_tracker';
    ...
    function InstallFiles() {
        ...
        CopyDirFiles(
                $_SERVER["DOCUMENT_ROOT"] . "/bitrix/modules/platina.convead_tracker/install/components/bitrix/catalog/templates/.default/bitrix/catalog.element/.default/component_epilog.php", $_SERVER["DOCUMENT_ROOT"] . "/bitrix/components/bitrix/catalog/templates/.default/bitrix/catalog.element/.default/component_epilog.php", true
        );
        return true;
    }
