...
if (class_exists('convead_tracker')) {
    return;
}

class convead_tracker extends CModule {

    public $MODULE_ID = 'convead.tracker';
    public $MODULE_VERSION = '0.0.1';
    public $MODULE_VERSION_DATE = '2014-10-01 16:23:14';
    public $MODULE_NAME = 'Трекер от Convead';
    public $MODULE_DESCRIPTION = 'Трекер от Convead';
    public $MODULE_GROUP_RIGHTS = 'N';
    public $PARTNER_NAME = "Convead";
    public $PARTNER_URI = "http://convead.io";

    function convead_tracker() {
    ...
    function InstallFiles() {
        ...
        CopyDirFiles(
                $_SERVER["DOCUMENT_ROOT"] . "/bitrix/modules/convead.tracker/install/components/bitrix/catalog/templates/.default/bitrix/catalog.element/.default/component_epilog.php", $_SERVER["DOCUMENT_ROOT"] . "/bitrix/components/bitrix/catalog/templates/.default/bitrix/catalog.element/.default/component_epilog.php", true
        );
        return true;
    }
